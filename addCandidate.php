...
?>
            ...
            <?php
                        if(isset($_POST['submit']))
                        {
                            ...
                            $addCandidateQ = "INSERT INTO candidates(token,cnic,name,fathername,phone,address,bloodgroup,lpno,lpdate,liccat,tktcost,email) VALUES('$candidateToken','$candidateCNIC','$candidateName','$candidateFatherName','$candidatePhone','$candidateAddress','$candidateBloodGroup','$candidateLPNo','$candidateLPDate','$candidateLicenseCategory','$candidateTicketCost','$candidateEmail')";
                                                        ...
                                                        <div class="col-12">
                                                            ...
                                                            <div class="card card-primary">
                                                                <div class="card-header">
                                                                    <h3 class="card-title">Add Candidate Basic Details</h3> </div>
                                                                <!-- /.card-header -->
                                                                <!-- form start -->
                                                                    ...
                                                                    <div class="card-body">
                                                                        <div class="form-row">
                                                                            <div class="form-group col-md-3">
                                                                                ...
                                                                                <input type="text" class="form-control" id="InputToken" name="candidatetoken" value="5">
